...
public class _10determinaMes {
	public static void main (String[] args) {
		
		String mesEntrada;
		int mes;
		
		mesEntrada = JOptionPane.showInputDialog("Coloca el numero del mes");
		mes = Integer.parseInt(mesEntrada);
		
		if (mes < 0 || mes > 12) JOptionPane.showMessageDialog(null, "El numero de mes colocado es incorrecto");
